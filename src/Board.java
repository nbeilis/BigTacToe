...
public class Board extends JPanel
{
	...
	// Grid colours - CHANGED BY NICOLE AND LILLY
	private static final Color GRID_COLOR_A = new Color(119, 179, 234);
	private static final Color GRID_COLOR_B = new Color(186, 221, 255);
